    ...
    return (
        <PrivacyWrapper>
            ...
            <div className="content-privacy">
                ...
                <br/>
                <br/>
                2. The App is operated by Yana Shestakova and Shestakov Artem Olegovich, IP
                <br/>
                <br/>
                ...
                <br/><br/>15. You hereby release Yana Shestakova and Shestakov Artem Olegovich, IP, its officers, directors, agents, and employees from all claims, demands, and damages (actual and consequential) of any kind and nature, known and unknown, suspected and unsuspected, disclosed and undisclosed, arising out of, or in any way, connected with any disputes arising between you and any suppliers, or between you and other App or Website users.
                ...
                <br/><br/>21. THE APP, ITS CONTENT, INCLUDING TEXT, GRAPHICS, IMAGES OR OTHER COMPONENTS IS PROVIDED “AS IS” WITH ALL ERRORS, WITHOUT WARRANTIES OF ANY KIND, TECHNICAL CHARACTERISTICS SUPPORT AND YOU AGREE TO USE THEREOF AT YOUR OWN RISK. YANA SHESTAKOVA AND SHESTAKOV ARTEM OLEGOVICH, IP DO NOT WARRANT THE ACCURACY, ADEQUACY OR COMPLETENESS OF THIS INFORMATION AND MATERIALS, SATISFACTORY QUALITY AND PRODUCTIVITY, CONTINUOUS USE, FITNESS FOR A PARTICULAR PURPOSE AND EXPRESSLY DISCLAIMS LIABILITY FOR ERRORS OR OMISSIONS IN INFORMATION, MATERIALS AND CORRECTION THEREOF. YANA SHESTAKOVA AND SHESTAKOV ARTEM OLEGOVICH, IP PERFORM NO WARRANTY TO YOUR SATISFACTION BY CONTENT OF THIS WEBSITE, ITS COMPLIANCE WITH YOUR NEEDS, NO WARRANTY OF ANY KIND, IMPLIED, EXPRESSED OR STATUTORY INCLUDING BUT NOT LIMITED TO THE WARRANTIES OF NON-INFRINGEMENT OF THIRD PARTY RIGHTS, TITLE, MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE.
